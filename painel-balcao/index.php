...
<!-- Sidebar Menu SISTEMA-->
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item ">
            <a href="index.php?pagina=pedidos" class="nav-link">
              <i class="nav-icon fas fa-tachometer-alt"></i><p>Pedidos</p>
            </a>
          </li>

          <li class="nav-item">
            <a href="index.php?pagina=montar-pedido" class="nav-link">
              <i class="nav-icon far fa-folder-open"></i><p>Montar Pedido</p>
            </a>
          </li>
