...
if($total_reg1 == 0){
    $pdo->query("INSERT INTO cargos SET nome = 'Adminsitrador'");
    $pdo->query("INSERT INTO cargos SET nome = 'Cozinha' ");
    $pdo->query("INSERT INTO cargos SET nome = 'Atendente' ");
    $pdo->query("INSERT INTO cargos SET nome = 'Motoboy' ");
}
...
if($total_reg2 == 0){
    $pdo->query("INSERT INTO config SET nome = '$nome_sistema', email_adm = '$email_adm', logs = 'Sim', logo='logo.png', favicon='favicon.ico' ");
}

$email_adm = 'diego@ithub.com.br';
//VALIDAÇÃO 
$query3 = $pdo->query("SELECT * FROM usuarios");
...
if($total_reg3 == 0){
    $pdo->query("INSERT INTO usuarios 
                    SET nome='Root', cpf='000.000.000-00', usuario='$email_adm', senha='$senha_cript', nivel='Administrador', foto='sem-perfil.jpg' 
                ");
} 
...
<head>
    ...
    <meta name="description" content="Pizzas, Pizza Artesanal, São Paulo, Comprar Pizza, hamburguer, burguer, Lanches em Venda, Comprar Sanduíche">
    <meta name="author" content="iTHub Tecnologia">
            ...
            <div class="row">
                    ...
                    <h5 class="text-center mb-4">Faça seu Login</h5>
                        ...
                        <form class="login100-form validate-form" method="post" action="autenticar.php">
                            ...
                            <div class="wrap-input100 validate-input">
                                ...
                                <input class="input100" type="password" id="pass" name="pass" placeholder="Senha ou CPF (Ex: 000.000.000-00)" required>
               ...
               <div class="col-md-8 banner-sec">   
                  ...
                  <div class="banner">
                    ...
                    <?php                         
                        $sql = $pdo->query("SELECT * FROM banner_login ORDER BY dt_registro DESC ");
                        $dd_img = $sql->fetchAll(PDO::FETCH_ASSOC);                       
                        $img_dd = count($dd_img);
                    ...
                    ?>
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <!-- <label><?php echo $img_dd ?></label> -->
                                <a href="digopizza">
                                    <img src="images/banner_login/<?php echo $img_dd ?>" height="" width="100%">
                                </a>
                            </div>
                        </div>
...
<div class="modal fade" id="modal-login" tabindex="-1" role="dialog">
  ...
  <div class="modal-body">
    <form method="post">
        ...
        <div class="col-md-6">
         <div class="form-group">
            <label class="text-dark" for="exampleInputEmail1">WhatsApp</label>
            <input type="text" class="form-control" id="telefone" name="whatsapp" placeholder="Whatsapp">
        </div>
    </div>
</div>
